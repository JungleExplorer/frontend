import All_Beauty from "./All_Beauty_top3000_metadata.json";
import Amazon_Fashion from "./Amazon_Fashion_top3000_metadata.json";
import Appliances from "./Appliances_top3000_metadata.json";
import Arts_Crafts_and_Sewing from "./Arts_Crafts_and_Sewing_top3000_metadata.json";
...
import Digital_Music from "./Digital_Music_top3000_metadata.json";
import Electronics from "./Electronics_top3000_metadata.json";
import Gift_Cards from "./Gift_Cards_top3000_metadata.json";
import Grocery_and_Gourmet_Food from "./Grocery_and_Gourmet_Food_top3000_metadata.json";
import Handmade_Products from "./Handmade_Products_top3000_metadata.json";
import Health_and_Household from "./Health_and_Household_top3000_metadata.json";
...
import Office_Products from "./Office_Products_top3000_metadata.json";
import Patio_Lawn_and_Garden from "./Patio_Lawn_and_Garden_top3000_metadata.json";
import Pet_Supplies from "./Pet_Supplies_top3000_metadata.json";
import Software from "./Software_top3000_metadata.json";
import Sports_and_Outdoors from "./Sports_and_Outdoors_top3000_metadata.json";
import Subscription_Boxes from "./Subscription_Boxes_top3000_metadata.json";
import Tools_and_Home_Improvement from "./Tools_and_Home_Improvement_top3000_metadata.json";
import Toys_and_Games from "./Toys_and_Games_top3000_metadata.json";
import Video_Games from "./Video_Games_top3000_metadata.json";
